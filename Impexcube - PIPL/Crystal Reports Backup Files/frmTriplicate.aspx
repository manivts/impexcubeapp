<%@ Page Title="" Language="C#" MasterPageFile="~/ImpexCube.Master" AutoEventWireup="true"
    CodeBehind="frmTriplicate.aspx.cs" Inherits="ImpexCube.frmTriplicate" %>
            ...
            <td>
                ...
                <table style="width: 85%; height: 54px; border-color: #2461BF; border-style: solid;
                    ...
                    <tr style="background-color: #2461BF;">
                        <td align="center" style="width: 1080px">
                            <asp:Label ID="Label1" runat="server" Text="Triplicate  Reports" Width="804px" Font-Names="Verdana"
                ...
                <asp:GridView ID="GrdAllJob" AllowPaging="True" runat="server" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="be_type" HeaderText="HC/B/XB" SortExpression="be_type">
                            <ItemStyle Wrap="False" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="GROSS_WT" HeaderText="QTY(KG)" SortExpression="GROSS_WT">
                            <ItemStyle Wrap="False" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="INV_VALUE" HeaderText="AMOUNT" SortExpression="INV_VALUE">
                            <ItemStyle Wrap="true" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FRT_BANK" HeaderText="BANK" SortExpression="FRT_BANK">
                            <ItemStyle Wrap="true" />
                        </asp:BoundField>
                    </Columns>
                </asp:GridView>
