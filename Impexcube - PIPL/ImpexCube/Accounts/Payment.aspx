    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table align="center" style="width: 70%;">
                ...
                <tr>
                    <td class="style4" colspan="3" style="text-align: left">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlAccountCr" runat="server"  Style="margin-top: 0px;" 
                                        AppendDataBoundItems="true" CssClass="ddl200" Width="400px">
                                    </asp:DropDownList>
                                </td>

                                <td id='td003' runat="server"   style="text-align: left">
                                    <asp:TextBox ID="txtChqNo" runat="server" Enabled="false" CssClass="textbox100" 
                                      ></asp:TextBox>
                                </td>
                                <td id='td004' runat="server" style="text-align: left;">
                                    <asp:TextBox ID="txtChqDate" runat="server" Enabled="False" 
                                        MaxLength="10" CssClass="textbox100"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlAccountDr" runat="server" AppendDataBoundItems="True" 
                                        AutoPostBack="True" CssClass="ddl200" 
                                        onselectedindexchanged="ddlAccountDr_SelectedIndexChanged" Width="400px" 
                                        >
                                ...
                                <td>
                                    ...
                                    <%--<asp:ImageButton ID="btnAdd" runat="server" ImageUrl="~/Accounts/AccImages/AddNew.png"
                                        Width="24px" OnClick="btnAdd_Click1" />--%>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="text-align: left" width="65" align="right">
                        <asp:Label ID="lblNarration" runat="server" CssClass="style16" Width="20px" Text="Narration"></asp:Label>
                    </td>
                    <td style="text-align: left" width="470px" align="left">
                        <asp:TextBox ID="txtNarration" runat="server" AutoPostBack="false" 
                            Style="text-align: left" CssClass="txtbox300" width="450px"></asp:TextBox>
                    </td>
                    <td class="style17">
                ...
                <tr>
                    <td class="style21" colspan="3" style="text-align: center">
                        ...
                        <asp:Button ID="btnNew" runat="server" CausesValidation="false" OnClick="btnNew_Click"
                            Style="height: 26px" Text="New" Width="70px" CssClass="btn70" />
                        &nbsp;&nbsp;
                        <asp:Button ID="ButtonPrint" runat="server" OnClick="ButtonPrint_Click" Text="Print"
                            Visible="False" Width="70px" CssClass="btn70" />
                        &nbsp;&nbsp;
