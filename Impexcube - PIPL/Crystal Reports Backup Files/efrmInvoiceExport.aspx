                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td class="style9">
                                                    <asp:Label ID="Label46" runat="server" CssClass="fontsize" Text="Amount in INR"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnNew" runat="server" BackColor="#73AAE8" OnClick="btnNew_Click"
                                                        Text="New" CssClass="ui-priority-primary" OnClientClick="javascript:return NewInvoice();" />
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Label ID="Label12" runat="server" CssClass="fontsize" Text="ShowFOB in"></asp:Label>
                                                    </td>
                                                    <td>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtExpContNoDt" runat="server" CssClass="textbox150"></asp:TextBox>
                                                    </td>
                                                    <td>
