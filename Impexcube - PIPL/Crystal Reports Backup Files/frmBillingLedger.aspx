<%@ Page Language="C#" MasterPageFile="~/Billing/MasterPage.master" AutoEventWireup="true" Inherits="frmBillingLedger" Title="::PIPLBilling || Billing Summary Report Status " Codebehind="frmBillingLedger.aspx.cs" %>
...
<asp:RadioButtonList ID="rbBill" runat="server" Font-Names="Arial" Font-Size="8pt" 
        RepeatDirection="Horizontal" AutoPostBack="True" 
        OnSelectedIndexChanged="rbBill_SelectedIndexChanged" Width="150px">
            ...
            <td >
                        ...
                        <table>
                            ...
                            <tr valign="middle">
                                ...
                                <td>
                                    <asp:CheckBox ID="chkLedger" runat="server" AutoPostBack="true" Checked="false" 
                                        Font-Names="Arial" Font-Size="8pt" OnCheckedChanged="chkLedger_CheckedChanged" 
                                        Text="Ledger Name" Width="90px" />
                                </td>
                                <td>
...
<td align="left">
            ...
            <td align="left">
                <asp:Button ID="btnExport" runat="server" Text="Export to Excel" Font-Names="Arial"
                    Font-Size="8pt" OnClick="btnExport_Click" Width="90px" CssClass="button_image1" Height="25px"  />
            </td>
            <td  align="left">
                             ...
                             <asp:BoundField DataField="service_tax" HeaderText="SERVICE TAX" SortExpression="Desc" />
                              <asp:BoundField DataField="edu_cess" HeaderText="EDU CESS" SortExpression="Desc" />
                               <asp:BoundField DataField="sec_chess" HeaderText="SHC CESS" SortExpression="Desc" />
                                <asp:BoundField DataField="suffix" HeaderText="TOTAL" SortExpression="Desc" />
