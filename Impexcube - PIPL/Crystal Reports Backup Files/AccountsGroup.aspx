<%@ Page Language="C#" MasterPageFile="~/ImpexCube.Master" AutoEventWireup="true"
    CodeBehind="AccountsGroup.aspx.cs" Inherits="ImpexCube.Accounts.AccountsGroup"
    Title="Group" %>
        ...
        <ContentTemplate>
            <table align="center" style="width: 58%;">
                ...
                <tr>
                    ...
                    <td align="left" >
                        <asp:TextBox ID="txtGroupCode" runat="server" CssClass="textbox140" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textbox140" ></asp:TextBox>                       
                ...
                <tr>
                    <td align="left" class="style13" colspan="3">
                        <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" OnClientClick="javascript:return validate();"
                            Text="Save"  CssClass="masterbutton" />
                        <asp:Button ID="btnUpdate" runat="server" OnClick="btnUpdate_Click" 
                            Text="Update" CssClass="masterbutton" />
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="grdGroup" runat="server" AllowPaging="true" AllowSorting="true"
                            ...
                            ShowFooter="false" ShowHeader="true" Style="text-align: left" Width="604px">
                            ...
                            <Columns>
                                <asp:CommandField ButtonType="Image" HeaderText="Select" ItemStyle-Font-Bold="false"
                                    ItemStyle-Font-Names="Arial" SelectImageUrl="~/Content/Images/edit.PNG" ShowSelectButton="true">
