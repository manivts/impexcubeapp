...
<body>
    ...
    <table style="z-index: 101; left: 15px; position: absolute; top: 0px">
        <tr>
        <td>
                <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt" Text="User Name :" ForeColor="DodgerBlue"></asp:Label>
                <asp:Label ID="lblUser" runat="server" Font-Bold="False" Font-Names="Verdana" Font-Size="8pt" ForeColor="RoyalBlue" ></asp:Label>
         
            </td>
            <td style="width: 7px">
                <asp:Label ID="Label4" runat="server" ForeColor="#2461BF" Text="||"></asp:Label></td>
            <td>
                <asp:LinkButton ID="LB_Logout" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="8pt" Font-Underline="False" ForeColor="#2461BF" OnClick="LB_Logout_Click" CausesValidation="False">Sign Out</asp:LinkButton>
            </td>
        </tr>
    </table>
    <table style="z-index: 101; right: 15px; position: absolute; top:1px">
<tr>
<td>
<asp:Label ID="lblCompName" runat="server" Text=""  Font-Bold="True" Font-Names="Arial" Font-Size="10pt" Height="18px"></asp:Label>
</td>
</tr>
</table>
   ...
   <br />
    <table style="width: 100%; height: 400px; border: 1px;">
                <tr>
                    <td style="height: 20%">
                        <table style="width: 100%;">
                            <tr style="background-color: #ff6600; height: 10px;">
                                <td>
                                </td>
                            </tr>
                            <tr style="background-color: #2461bf;">
                                <td style="width: 100%;">
                                    <table style="background-color: #2461bf; width: 100%">
                                        <tr>
                                            <td style="width: 75%">
                                                <asp:Label ID="lblDate" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10pt"
                                                    ForeColor="White" Width="14%"></asp:Label>
                                                <asp:Label ID="lblTime" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10pt"
                                                    ForeColor="White" Width="30%"></asp:Label>
                                            </td>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: top;" align="center" class="style1" >
                                                                <asp:Label ID="Label1" runat="server" Text="PARTICULARS" Font-Size="8pt" 
                                                            ...
                                                            <td align="center" style="vertical-align: top;" >
                                                                <asp:Label ID="Label5" runat="server" Text="TAX" Font-Size="8pt" 
                                                                    Font-Names="Arial" Font-Bold="False"></asp:Label>
                                                            </td>
                                                            <td align="center" style="vertical-align: top;" >
                                                                <asp:Label ID="Label7" runat="server" Text="AMOUNT Rs." Font-Size="8pt" 
                                                                    Font-Names="Arial" Font-Bold="False"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                            <ContentTemplate>
                                                                                <table  style="border-color: #2461BF; border-style: solid;
                                                                                    border-width: 1px; width: 532px;">
                                                                                    <tr>
                                                                                        <td style="vertical-align: top;">
                                                                                         <div style="width: 525px; height: 245px" class="grid_scroll">
                                                                                        <asp:GridView ID="GridView1" runat="server" CellPadding="3"  Font-Names="Arial" Font-Size="8pt" BackColor="White"
                                                                                BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1" 
                                                                                GridLines="None" AutoGenerateColumns="False" Width="520px" ShowHeader="false"  OnRowDataBound="GridView1_RowDataBound">
                                                                                ...
                                                                                <HeaderStyle BackColor="#2461BF" Font-Bold="True" ForeColor="#E7E7FF" />
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:TemplateField HeaderText="RECEIPT">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:TextBox ID="txtRECPT" runat="server" Width="100px" 
                                                                    ...
                                                                    <td>
                                                                        <asp:Panel ID="Panel1" runat="server" Font-Names="Arial" BackColor="#DEDFDE" Font-Size="7pt"
                                                                            ...
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" class="style2">
                                                                                        <asp:Label ID="Label50" runat="server" Font-Names="Arial" Font-Size="8pt" 
                                                                                            ForeColor="Black" Text="Tally Account Name" Width="100px"></asp:Label>
                                                                                    </td>
                                                                                    <td align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" class="style2">
                                                                                        <asp:Label ID="Label51" runat="server" Font-Names="Arial" Font-Size="8pt" 
                                                                                            ForeColor="Black" Text="Tally Sub Party Name" Width="120px"></asp:Label>
                                                                                    </td>
                                                                                    <td align="left" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" class="style2" >
                                                                                        <asp:Label ID="Label11" runat="server" Text="City" Font-Names="Arial" 
                                         ...
                                         <td colspan="2" style="border: 1px solid #2461BF; " align="right" >
                                                        ...
                                                        <asp:Button ID="Button2" runat="server" Font-Names="Arial" Font-Size="8pt" 
                                                            Height="25px" Text="Exit" Width="50px" CssClass="button_image1" 
        ...
        <cc1:RoundedCornersExtender ID="RCE1" TargetControlID="Panel1" Radius="10" Corners="top" runat="server">
        </cc1:RoundedCornersExtender>
        <cc1:RoundedCornersExtender ID="REC2" TargetControlID="Panel2" Radius="10" BorderColor="#2461bf" Corners="Top"  runat="server">
        </cc1:RoundedCornersExtender>
