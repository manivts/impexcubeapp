<%@ Page Language="C#" MasterPageFile="~/Billing/MasterPage.master" AutoEventWireup="true" Inherits="frmPrintInvoice" Title="::PIPL || Print Billing" Codebehind="frmPrintInvoice.aspx.cs" %>
...
<cc1:AutoCompleteExtender ID="autoComplete2" runat="server" TargetControlID="txtInvoiceNo"
    ...
    <cc1:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" TargetControlID="txtPname"
                ...
                <td align="left" style="height: 26px">
                   ...
                   <td style="width:60px; height: 26px;">
                     <asp:CheckBox ID="chkImp" Text="Importer" Font-Names="arial" Font-Size="8pt" 
                           runat="server" AutoPostBack="True" oncheckedchanged="chkImp_CheckedChanged" />
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:CommandField ButtonType="Link" ItemStyle-Font-Bold="false" 
                            ItemStyle-Font-Names="Arial" SelectText="Print Bill" ShowSelectButton="true">
                            <ItemStyle Font-Bold="False" Width="40px" Font-Names="Arial" />
                        </asp:CommandField>
