  ...
  function FindCity(tb)
    ...
    <cc1:TabContainer ID="TabContainer1" Width="950px" runat="server" ActiveTabIndex="0"
        Font-Names="Arial" Font-Size="8pt">
                <cc1:TabPanel runat="server"  Width="950px" HeaderText="Single" ID="TabPanel1">
            <ContentTemplate>
        ...
        <cc1:TabPanel ID="TabPanel2" Width="950px" runat="server" HeaderText="Multiple">
            <ContentTemplate>
                <table style="Width:950px">
                    <tr>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <table>
                                        ...
                                        CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListItemCssClass="listItem"
                                        EnableCaching="true" MinimumPrefixLength="0" ServiceMethod="GetConsignor" ServicePath="~/AutoComplete.asmx"
        ...
        <cc1:TabPanel ID="TabPanel3"  Width="950px" runat="server" HeaderText="Find" Visible="false">
            <ContentTemplate>
                <table style="Width:950px">
                    <tr>
                        <td>
