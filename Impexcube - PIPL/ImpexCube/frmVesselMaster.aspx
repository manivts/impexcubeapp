        ...
        <table>
                <tr>
                 ...
                 <tr>
                    ...
                    <td >
                        <asp:TextBox ID="txtVesselcode" runat="server" CssClass="textbox150"></asp:TextBox><font color="red"><strong>*</strong></font>
                    </td>
                </tr>
                <tr>
                    <td align="center" class="fontsize">
                    ...
                    <td>
                        <asp:TextBox ID="txtVesselName" runat="server" 
                            CssClass="textbox150" ></asp:TextBox><font color="red"><strong>*</strong></font>
                    </td>
                </tr>
                ...
                <td style="text-align: center" colspan="2">
                    ...
                    <asp:Button ID="btnDiscard" runat="server" Text="Exit" 
                        onclick="btnDiscard_Click1" CssClass="masterbutton" OnClientClick="javascript:return exit();" />
                        </td>                   
