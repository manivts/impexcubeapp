            ...
            <td style="height: 307px; vertical-align: top;">
                ...
                <div id="GridScroll" class="grid_scrollbig">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        FoFont-Names="Arial" Font-Size="8pt" ShowHeader="False" Width="154px" DataKeyNames="job_no"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="False" HeaderText="IMPORTER">
                                <ItemTemplate>
                                    <asp:Label ID="lblImporter" Visible="false" runat="server" Text='<%#Bind("party_name") %>'
                            ...
                            <asp:TemplateField HeaderText="IMPORTER">
                                <ItemTemplate>
                                    <asp:Label ID="lblImp" runat="server" ToolTip='<%#Bind("party_name")%>' Text='<%#Bind("party_code") %>'
                                        Font-Names="Arial" Font-Size="8pt" Width="40px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle VerticalAlign="Top" />
                            </asp:TemplateField>
