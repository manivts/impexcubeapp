...
<body>
    ...
    <div style="vertical-align: top;">
        ...
        <table style="z-index: 101; right: 15px; position: absolute; top: 0px">
            <tr>
                <td>
                    <asp:Label ID="llbHead" runat="server" Text="Professional Impex Pvt. Ltd.," Font-Bold="True"
                                        ...
                                        <td style="width: 75%">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="width: 7px">
                                                        <asp:Label ID="Label4" runat="server" ForeColor="White" Text="||" Font-Size="8pt"></asp:Label>
                                                    </td>
                                                    <td>
                                                                    ...
                                                                    <asp:Panel ID="Panel3" runat="server" BackColor="#DEDFDE" Font-Names="Arial" Font-Size="7pt"
                                                                        ...
                                                                        <table style="width: 362px">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:CheckBox ID="chkSupplierInvNo" runat="server" 
                                                                                        oncheckedchanged="chkSupplierInvNo_CheckedChanged" AutoPostBack="True" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </asp:Panel>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #2461BF; vertical-align: top;" align="right">
                                                        ...
                                                        <asp:Button ID="BtnExit" runat="server" Font-Names="Arial" CssClass="button_image1"
                                                            ...
                                                            PostBackUrl="~/index.aspx" onclick="BtnExit_Click" />
                                                    </td>
                                                </tr>
                                            </table>
