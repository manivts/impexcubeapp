<%@ Page Language="C#" MasterPageFile="~/ImpexCube.Master" AutoEventWireup="true" Inherits="ImpexCube.Dashboard_frmInwardUpdate" Title=" :: Front Desk || INWARD BILL UPDATE" Codebehind="frmInwardUpdate.aspx.cs" %>
    ...
    <table style="width: 100%;">
        <tr style="background-color: #719ddb;">
            <td align="center" colspan="4">
                <asp:Label ID="Label2" Font-Names="calibri" Font-Size="12pt" runat="server" Text="Inward Update Information"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            <td align="right">
                <asp:Label ID="Label30" Font-Names="arial" Font-Size="8pt" runat="server" Text="Inward Date :"></asp:Label>
            </td>
            <td style="width: 199px">
        ...
        <tr style="background-color: #719bdf;">
            <td colspan="4">
                <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Names="Arial" 
                    Font-Size="8pt" ForeColor="White" Text="Received Info : -"></asp:Label>
            </td>
        </tr>
        <tr>
        <td align="right" >
                <asp:Label ID="Label10" runat="server" Font-Names="arial" Font-Size="8pt" 
                    Text="Sent Date:"></asp:Label>
            </td>
            <td>
