<%@ Page Title="" Language="C#" MasterPageFile="~/ImpexCube.Master" AutoEventWireup="true" CodeBehind="frmJobImporterWiseReport.aspx.cs" Inherits="ImpexCube.frmJobImporterWiseReport" EnableEventValidation="false" %>
                                    ...
                                    <asp:Panel ID="aa" runat="server">
                                        <asp:GridView ID="Grdiworkreg" runat="server" BackColor="White" BorderColor="#3366CC"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ShipmentCountry" HeaderText="COUNTRY" SortExpression="ShipmentCountry" />
                                                <asp:BoundField DataField="ShippingLine" HeaderText="S/LINE" SortExpression="ShippingLine" />
                                                <asp:BoundField DataField="MasterBLNo" HeaderText="MAWB/MBL NO" SortExpression="MasterBLNo" />
                                                <asp:BoundField DataField="MasterBLDate" HeaderText="MAWB/MBL DATE" SortExpression="MasterBLDate" />
                                                <asp:BoundField DataField="HouseBLNo" HeaderText="HAWB/HBL NO" SortExpression="HouseBLNo" />
                                                <asp:BoundField DataField="HouseBLDate" HeaderText="HAWB/HBL Date" SortExpression="HouseBLDate" />
                                                <asp:BoundField DataField="InvoiceDetail" HeaderText="DESCRIPTION" SortExpression="InvoiceDetail">
                                                    <ItemStyle Wrap="False" />
                                                </asp:BoundField>
