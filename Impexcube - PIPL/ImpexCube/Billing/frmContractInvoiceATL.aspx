<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="frmContractInvoiceATL" Codebehind="frmContractInvoiceATL.aspx.cs" %>
...
<head runat="server">
    <title>::PIPL || APOLLO INVOICE</title>
    <style type="text/css">
.accordionContent {
           ...
           <br />
            ...
            <table style="width: 100%; height: 400px; border: 1px;">
                ...
                <tr>
                    ...
                    <td style="width: 7px">
                        <asp:Label ID="Label4" runat="server" ForeColor="White" Text="||" 
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" class="style4">
                                                                                    <asp:Label ID="Label50" runat="server" Font-Names="Arial" Font-Size="8pt" 
                                                                                        Text="Bill Type :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                    <asp:CheckBoxList ID="chkBills" Font-Names="Arial" Font-Size="8pt" 
                                                                                        runat="server" RepeatDirection="Horizontal">
                                                                                        <asp:ListItem Value="ATLSB">Invoice</asp:ListItem>
                                                                                        <asp:ListItem Value="ATLDB">Debit Note</asp:ListItem>
                                                                                        <asp:ListItem Value="ATLDEM">Demurrage</asp:ListItem>
                                                                                    </asp:CheckBoxList>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="width: 610px; height: 16px">
                                                                                        <asp:Label ID="lblIName" runat="server" Font-Names="arial" Font-Size="10pt" Font-Bold="True">APOLLO 
                                                                                        CONTRACT INVOICE - IMPORTS</asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                ...
                                                <cc1:Accordion ID="Accordion1" HeaderCssClass="accordionHeader" HeaderSelectedCssClass="accordionHeaderSelected"
                                                    ...
                                                    <Panes>
                                                        ...
                                                        <cc1:AccordionPane ID="AccPan2" runat="server">
                                                            ...
                                                            <Content>
                                                                <asp:TextBox ID="txtIndentRemark" Font-Names="Arial" Font-Size="8pt" Width="500px" runat="server"></asp:TextBox>
                                                                </Content>
                                                        </cc1:AccordionPane>
                                                    </Panes>
                                                </cc1:Accordion>
                                         ...
                                         <td  style="border: 1px solid #2461BF; vertical-align: top; " align="right" >
                                                    ...
                                                    Font-Size="8pt" Height="25px"  Text="Exit" Width="50px" 
