            ...
            <table align="center" width="75%">
                ...
                <tr>
                    <td colspan="3" style="text-align: center">
                        ...
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lnkExit" runat="server" PostBackUrl="~/Accounts/MainMenu.aspx" CssClass="style8">Exit</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align: center">
                        ...
                        <asp:GridView ID="gvReceiptDetail" runat="server" Style="text-align: left; font-family: Verdana;
                            ...
                            <Columns>
                                <asp:CommandField ButtonType="Image" ItemStyle-Font-Bold="false" ItemStyle-Font-Names="Arial"
                                    ShowSelectButton="true" SelectImageUrl="~/Accounts/AccImages/view_icon.gif" HeaderText="Select">
