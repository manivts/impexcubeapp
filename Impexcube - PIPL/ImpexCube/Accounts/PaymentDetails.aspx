        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table align="center" width="75%">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:LinkButton ID="lnkNew" runat="server" Style="text-align: left"  
                                OnClick="lnkNew_Click" CssClass="style11">New</asp:LinkButton>
                            &nbsp;&nbsp;
                            <asp:LinkButton ID="lnkExit" runat="server" PostBackUrl="~/Accounts/MainMenu.aspx" 
                                onclick="lnkExit_Click" CssClass="style11">Exit</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: center">
                           ...
                           <%-- <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" TargetControlID="txtKeyword"
                            ...
                            <asp:Button ID="btnSearch" runat="server" Text="Search" 
                                OnClick="btnSearch_Click" CssClass="btn70" />
                            &nbsp;
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <asp:GridView ID="gvPaymentDetail" runat="server" 
                                ...
                                OnSorting="gvPaymentDetail_Sorting" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Print">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnPrint" runat="server" ImageUrl="~/Accounts/AccImages/print-icon.png" ToolTip="Print"
