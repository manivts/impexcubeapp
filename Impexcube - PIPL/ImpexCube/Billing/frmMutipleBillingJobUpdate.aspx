<%@ Page Language="C#" MasterPageFile="~/Billing/MasterPage.master" AutoEventWireup="true" Inherits="frmMutipleBillingJobUpdate"
    Title="Untitled Page" Codebehind="frmMutipleBillingJobUpdate.aspx.cs" %>
...
function RestrictInt(val)
 {
    ...
    <div id="dvmain" runat="server" style="height: 100%">
        <table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Panel ID="Panel1" runat="server" Font-Names="Arial" BorderColor="#9966ff" BackColor="#DEDFDE"
                                                    Font-Size="7pt" GroupingText="Customer Info" Width="320px" ForeColor="#000040">
                                                    <table>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 278px">
                                                                <asp:TextBox ID="txtSubParty" runat="server" Width="200px" Font-Names="Arial" Font-Size="8pt"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 56px; height: 20px;">
                                                                <asp:Label ID="Label20" runat="server" Text="Party Ref" Font-Names="Arial" Font-Size="8pt"
                                                                    Width="62px" ForeColor="Black"></asp:Label>
                                                            </td>
                                                ...
                                                <asp:Panel ID="Panel3" runat="server" BorderColor="#9966ff" BackColor="#DEDFDE" Font-Names="Arial"
                                                    Font-Size="7pt" ForeColor="#000040" GroupingText="Job Info" Width="320px">
                                                    <table>
                                                        <tr>
    ...
    <table id="tbmultiplejob" runat="server" align="center" style="width: 440px">
        <tr id="TrMultipleJob" runat="server">
            <td style="vertical-align: top; text-align: center;" align="left" 
                class="style37" colspan="3">
                &nbsp;</td>
        </tr>
        <tr  runat="server">
            <td style="vertical-align: top; text-align: center;" align="left" 
                ...
                <asp:TextBox ID="txtjobno1" Font-Names="Arial" Font-Size="8pt" runat="server" OnTextChanged="txtJNO_TextChanged"
                    Width="70px"></asp:TextBox>
                <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" EnableCaching="true"
                    ...
                    CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListItemCssClass="listItem"
                    ServicePath="~/AutoComplete.asmx" TargetControlID="txtjobno1">
                </cc1:AutoCompleteExtender>
                <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" TargetControlID="txtjobno1"
                    WatermarkCssClass="waterText" WatermarkText="75079" runat="server">
                </cc1:TextBoxWatermarkExtender>
            ...
            <td style="vertical-align: top;" align="left" class="style38">
                <asp:ListBox ID="lbjobno" runat="server" Width="150px"></asp:ListBox>
            
            </td>
        </tr>
        <tr  runat="server">
            <td style="vertical-align: top; text-align: center;" align="left" 
                class="style38" colspan="3">
                <asp:Button ID="btnsubmit" runat="server" onclick="btnsubmit_Click" 
                    Text="Submit" />
&nbsp;&nbsp;
                <asp:Button ID="btnexit1" runat="server" onclick="btnexit1_Click" Text="Exit" />
