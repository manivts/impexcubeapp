                                    ...
                                    <td colspan="2">
                                        <div class="grid_scroll-2">
                                            <asp:GridView ID="gvContainerType" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                <asp:BoundField DataField="ContainerTypeId" HeaderStyle-HorizontalAlign="Center" 
                                                        HeaderText="ContainerTypeId" InsertVisible="False" ReadOnly="True" 
                                                        SortExpression="ContainerType" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
