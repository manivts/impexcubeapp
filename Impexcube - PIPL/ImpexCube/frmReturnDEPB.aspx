<%@ Page Title="" Language="C#" MasterPageFile="~/ImpexCube.Master" AutoEventWireup="true"
    CodeBehind="frmReturnDEPB.aspx.cs" Inherits="ImpexCube.frmReturnDEPB" %>
                ...
                <table style="width: 85%; height: 54px; border-color: #2461BF; border-style: solid;
                    ...
                    <tr style="background-color: #2461BF;">
                        <td align="center" style="width: 1080px">
                            <asp:Label ID="Label1" runat="server" Text="Return Discharged - DEPB" Width="804px"
                        ...
                        <td>
                            <asp:GridView ID="GrdAllJob" AllowPaging="True" runat="server" BackColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TOT_DUTY" HeaderText="DUTY" SortExpression="TOT_DUTY">
                                        <ItemStyle Wrap="true" />
                                    </asp:BoundField>
                                </Columns>
                            </asp:GridView>
