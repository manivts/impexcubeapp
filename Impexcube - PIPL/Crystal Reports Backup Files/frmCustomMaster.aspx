...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
     function valsave() {
         var custom = document.getElementById("<%= txtCustom.ClientID %>");
         var branch = document.getElementById("<%= txtBranch.ClientID %>");
         if (custom == "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="left">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCustom" runat="server" CssClass="textbox150" ></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td class="style2">
                <asp:TextBox ID="txtBranch" runat="server" CssClass="textbox150"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td  colspan="2">
